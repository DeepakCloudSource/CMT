					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Central Task Manager",
									"targetURL": "#atomuictm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atomuictm-display": {
								"semanticObject": "atomuictm",
								"action": "display",
								"description": "Central Task Manager",
								"title": "Central Task Manager",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=atom.ui.ctm",
									"url": sap.ui.require.toUrl("atom/ui/ctm")
								}
							}
						}
					}
